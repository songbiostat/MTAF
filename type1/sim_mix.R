...
print(paste("type1_mix",t,rho,sep = "_"))
...
setwd(paste0(path,"/","type1/mix/trait",t))

save(list = ls(all.names = TRUE), file = paste0("type1_mix","_",t,"_",rho,"_",core.i,".RData"), envir = .GlobalEnv)
