...
for(i in (1:rep)){
  ...
  beta <- c(runif(1,0.5,0.7),rep(0,49))
  #beta <- c(runif(10,0.2,0.35),rep(0,40))
...
print(paste("power_bin_z_",t,rho,sep = "_"))
...
setwd(paste0(path,"/","power/binary/covariates/trait",t,"/",sparsity))

save(list = ls(all.names = TRUE), file = paste0("power_bin_z","_",t,"_",sparsity,"_",rho,"_",core.i,".RData"), envir = .GlobalEnv)
