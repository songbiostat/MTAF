...
for(i in (1:rep)){
  ...
  # beta
  #beta <- c(runif(1,0.15,0.3),rep(0,9))
  #beta <- c(runif(4,0.05,0.2),rep(0,6))
  #beta <- c(runif(1,0.2,0.4),rep(0,49))
  #beta <- c(runif(10,0.05,0.13),rep(0,40))
...
print(paste("power_cont_z_",t,rho,sep = "_"))
...
setwd(paste0(path,"/","power/continuous/covariates/trait",t,"/",sparsity))
save(list = ls(all.names = TRUE), file = paste0("power_cont_z","_",t,"_",sparsity,"_",rho,"_",core.i,".RData"), envir = .GlobalEnv)
