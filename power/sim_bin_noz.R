...
for(i in (1:rep)){
  ...
  # beta
  #beta <- c(runif(1,0.4,0.6),rep(0,9))
  #beta <- c(runif(4,0.2,0.3),rep(0,6))
  #beta <- c(runif(1,0.6,0.8),rep(0,49))
  beta <- c(runif(10,0.15,0.3),rep(0,40))
...
print(paste("power_bin_noz_",t,rho,sep = "_"))
...
setwd(paste0(path,"/","power/binary/no_covariates/trait",t,"/",sparsity))

save(list = ls(all.names = TRUE), file = paste0("power_bin_noz","_",t,"_",sparsity,"_",rho,"_",core.i,".RData"), envir = .GlobalEnv)
